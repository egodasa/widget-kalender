...
;(function ( $, window, document, undefined ) {
  ...
  var clndrTemplate = "<div class='clndr-controls' style='background-color: #3BA0F3;padding: 1em 0;margin: 0;'>" +
    ...
    "</div>" +
  "<table class='clndr-table' border='0' cellspacing='0' cellpadding='0' style='background-color: #FBFBFB;'>" +
    "<thead>" +
    "<tr class='header-days' style='font-size: 10px;'>" +
  ...
  Clndr.prototype.init = function () {
    ...
    if(!this.options.daysOfTheWeek) {
      this.daysOfTheWeek = ["Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"];
      //~ for(var i = 0; i < 7; i++) {
  ...
  Clndr.prototype.render = function() {
    ...
    var bulanSekarang = daftarBulan[this.month.format('M')];
